...
const Index = ({ modalOpen, setModalOpen, selectedTransaction, closable = true }: { modalOpen: boolean, setModalOpen: Function, selectedTransaction: Row, closable?: boolean }) => {
    console.log(selectedTransaction)
    return ((
        <Modal
            open={modalOpen}
            onClose={() => {
                if (closable === true) { setModalOpen(false); }
            }}
